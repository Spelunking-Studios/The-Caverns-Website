...
export default function Footer() {
	return (
		<div className="transition ease-in-out static bottom-0 w-full bg-zinc-300 grid grid-cols-3 lg:grid-cols-4 py-5 px-4 lg:px-16 text-center gap-none dark:bg-zinc-800 dark:text-neutral-200">
			...
			<p className="text-2xl col-span-1 lg:col-span-2 font-cinzel">THE CAVERNS</p>
