...
export default function DownloadList() {
	return (
		<div className="flex flex-col w-1/2 mx-auto gap-10 pt-8 pb-16 dark:bg-zinc-700 dark:text-neutral-100">
			...
			<div className="flex flex-row bg-zinc-300 dark:bg-zinc-600 rounded-lg">
				<div className="flex-1  mt-auto mb-auto mx-auto">
					<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/MacOS_wordmark_%282017%29.svg/512px-MacOS_wordmark_%282017%29.svg.png" className="max-h-10 mx-auto mt-auto mb-auto"/>
				</div>
				<div className="flex-1">
			...
			<div className="flex flex-row bg-zinc-300 dark:bg-zinc-600 rounded-lg">
				<div className="flex-1  mt-auto mb-auto mx-auto">
					<img src="/images/debian-logo.png" className="h-auto w-auto max-h-20 mx-auto mt-auto mb-auto"/>
				</div>
				<div className="flex-1">
