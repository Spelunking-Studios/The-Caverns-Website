	...
	return (
		<div className={`${(darkMode % 2) ? "dark" : ""}`}>
		    <div className="flex flex-col min-h-screen w-full bg-zinc-100 dark:bg-zinc-700 dark:text-neutral-200">
				...
				<header className={`h-fit w-full overflow-hidden dark:bg-zinc-700 dark:text-neutral-200 pb-28 ${styles.pagewdbg}`}>	
					<img className="h-64 mx-auto mt-16 mb-10 w-auto h-auto aspect-auto" src="/images/TheCaverns.png"/>
					<h2 className="text-3xl text-center mx-auto dark:text-neutral-300 max-w-9/12">A top down indie action-adventure RPG.</h2>
				</header>
