      ...
      <div className="flex flex-col min-h-screen w-full dark:bg-zinc-700 dark:text-neutral-200">
        ...
        <main className="flex-grow w-full pt-20 ml-auto mr-auto min-h-full">
          <div className="grid grid-cols-3 gap-10 w-1/3 mx-auto pt-10 pb-10">
            ...
            <div className="transition ease-in-out rounded-lg rounded-lg border-4 border-zinc-800 dark:border-zinc-500 dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:hover:scale-105 p-6 col-span-3">
